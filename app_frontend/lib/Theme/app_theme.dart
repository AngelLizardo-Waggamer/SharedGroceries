...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    colorScheme: const ColorScheme(
      ...
      primaryContainer: Color(0xFFCFE5F0), // Azul muy claro para fondos de énfasis
      ...
      surfaceContainerHighest: Color(0xFFE1E3E8), // Gris azulado claro para superficies
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 57, fontWeight: FontWeight.w400, color: Color(0xFF001F2A)),
      headlineMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: Color(0xFF001F2A)),
      headlineSmall: TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Color(0xFF001F2A)),
      titleLarge: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF001F2A)),
      bodyLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, height: 1.6, color: Color(0xFF191C1E)),
      bodyMedium: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, height: 1.5, color: Color(0xFF191C1E)),
      labelLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF1A6B8A)),
    ),
