...
class CreateShoppingListDTO extends DTO {
  ...
  CreateShoppingListDTO({required this.name});
...
class ShoppingListIdDTO extends DTO {
  ...
  ShoppingListIdDTO({required this.listId});
...
class UpdateShoppingListStatusDTO extends DTO {
  ...
  UpdateShoppingListStatusDTO({required this.listId, required this.isActive});

  @override
  Map<String, dynamic> toJson() {
    return {'listId': listId, 'isActive': isActive};
  }
}
